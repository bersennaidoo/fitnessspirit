  ...
  return (
    <main>
      <div id="contact">
        ...
        <h4 className="mobile tel-link">
          <a href="tel:3119608">(+27) 311-9608</a>
        </h4>
        <h4 className="tablet-desktop tel-num">(333)5555678</h4>
        <h4>
          Email us:&nbsp;
          <a
            href="mailto:forwardfitnessspirit@club.net"
